...
const formatAgentStatus = (agent: LiveStatusAgent): JSX.Element => {
    ...
    return (
        ...
        <div className={`flex flex-col items-start p-3 rounded-lg shadow-md min-w-[250px] max-w-[550px] min-h-[200px] max-h-[550px] ${style.bgColor} border border-transparent`}>
    ...
    return (
        <div className="mt-2 mb-4 bg-gray-800 rounded-lg shadow-xl overflow-hidden animate-fade-in-up">
            ...
            <div 
                ...
                className="relative w-full min-h-[350px] max-h-[550px] flex items-center overflow-hidden overflow-x-auto scrollbar-hide cursor-grab"
                ...
                <div
                    className="whitespace-nowrap absolute will-change-transform flex items" // Añade flex y items-center
