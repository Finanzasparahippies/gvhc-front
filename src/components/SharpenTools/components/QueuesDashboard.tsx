...
const dashboardMetrics: MetricConfig[] = [
    { id: 'count_appt_line', title: 'Queue for Appointment Line', type: 'COUNT', queueName: 'Appointment Line RP1200' },
    { id: 'lcw_appt_line', title: 'Major Waiting Appointment Line', type: 'LCW', queueName: 'Appointment Line RP1200' },
    { id: 'count_es_appt_line', title: 'Queue for ES-Appointment Line', type: 'COUNT', queueName: 'ES-Appointment Line RP1200' },
    { id: 'lcw_es_appt_line', title: 'Major Waiting ES-Appointment Line', type: 'LCW', queueName: 'Es-Appointment Line RP1200' },
    { id: 'count_medrec', title: 'Queue for Medical Records', type: 'COUNT', queueName: 'Medical Records RP1260' },
    { id: 'lcw_medrec', title: 'Major Waiting Medical Records', type: 'LCW', queueName: 'Medical Records RP1260' },
    { id: 'count_es_med_records', title: 'Queue for ES-Medical Records', type: 'COUNT', queueName: 'ES-Medical Records RP1260' },
    { id: 'lcw_es_med_records', title: 'Major Waiting ES-Medical Records', type: 'LCW', queueName: 'ES-Medical Records RP1260' },
    { id: 'count_provider', title: 'Queue for ES-Provider Hotline', type: 'COUNT', queueName: 'Provider Hotline RP1270' },
    { id: 'lcw_provider', title: 'Major Waiting (ES-Provider Hotline', type: 'LCW', queueName: 'Provider Hotline RP1270' },
    { id: 'count_es_provider', title: 'Queue for ES-Provider Hotline', type: 'COUNT', queueName: 'ES-Provider Hotline RP1270' },
    { id: 'lcw_es_provider', title: 'Major Waiting (ES-Provider Hotline', type: 'LCW', queueName: 'ES-Provider Hotline RP1270' },
    { id: 'count_transport', title: 'Queue for Transportation', type: 'COUNT', queueName: 'Transportation' },
    { id: 'lcw_transport', title: 'Major Waiting Transportation', type: 'LCW', queueName: 'Transportation' },
    { id: 'count_dental', title: 'Queue for Dental', type: 'COUNT', queueName: 'Dental' },
    { id: 'lcw_dental', title: 'Major Waiting Dental', type: 'LCW', queueName: 'Dental' },
    { id: 'count_referals', title: 'Queue for Referrals', type: 'COUNT', queueName: 'Referals RP1250' },
    { id: 'lcw_referals', title: 'Major Waiting Referrals', type: 'LCW', queueName: 'Referals RP1250' },
    { id: 'count_es_referals', title: 'Queue for ES-Referrals', type: 'COUNT', queueName: 'ES-Referrals RP1250' },
    { id: 'lcw_es_referals', title: 'Major Waiting ES-Referrals', type: 'LCW', queueName: 'ES-Referrals RP1250' },
];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5">
                    {dashboardMetrics.map((metric) => {
                        ...
                        return (
                            <div key={metric.id} className="bg-gray-800 rounded-xl shadow-lg p-5 flex flex-col justify-between transform hover:-translate-y-1 transition-transform duration-200">
                                <div>
